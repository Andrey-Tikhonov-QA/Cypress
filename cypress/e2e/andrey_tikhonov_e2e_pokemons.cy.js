describe('Покупка аватара', function () {                                // название набора тестов
    it('e2e тест на покупку нового аватара для тренера', function () {   // название теста
         ...
         cy.get('.credit').type('4472426129801740');                     // вводим номер карты
         cy.get('.k_input_ccv').type('517');                             // вводим CVV карты
         cy.get('.k_input_date').type('1030');                           // вводим срок действия карты
         cy.get('.k_input_name').type('Nicole Uvarek');                  // вводим имя владельца действия карты
